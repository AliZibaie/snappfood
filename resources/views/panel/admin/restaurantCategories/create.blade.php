...
@section('content')
    <form method="post" action="{{route('restaurantCategories.store')}}" class="w-2/3 mx-auto mt-8">
        @csrf
        <div class="mb-6">
