...
@section('content')
    <form method="post" action="{{route('banners.store')}}" class="w-2/3 mx-auto mt-8" enctype="multipart/form-data">
        @csrf
        <div class="mb-6">
            @error('title')
