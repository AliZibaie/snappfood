...
@section('content')
    ...
    <div class="flex justify-end">
        <a href="{{route('foodCategories.create')}}"  class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-12 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 mt-12  ">
            افزودن
        </a>
    </div>
    <div class=" mb-20 relative overflow-x-auto shadow-md sm:rounded-lg mt-4">
        <p class="text-center text-xl">پنل مدیریت دسته بندی غذا</p>
                ...
                <tr class="border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex space-x-2">
                            <a href="{{route('foodCategories.edit', $foodCategory)}}" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900">تغییر</a>
