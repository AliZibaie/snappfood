...
@section('content')
    <form method="post" action="{{route('foodCategories.update', $foodCategory)}}" class="w-2/3 mx-auto mt-8">
        @csrf
        @method('PATCH')
        <div class="mb-6">
            @error('food_type')
