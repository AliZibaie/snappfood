...
@section('content')
    ...
    <form method="post" action="{{route('discounts.update', $discount)}}" class="w-2/3 mx-auto mt-8">
        @csrf
        @method('PUT')
        <div class="mb-6">
            @error('amount')
