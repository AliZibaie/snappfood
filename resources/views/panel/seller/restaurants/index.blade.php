                            ...
                            <div class="flex-none sm:flex">
                                ...
                                <div class="flex-auto sm:ml-5 justify-evenly">
                                    ...
                                    <div class="flex items-end pb-8  text-sm text-gray-400 flex-col space-y-2">
                                        ...
                                        <a href="{{route('addresses.index')}}"  class="flex-no-shrink bg-purple-400 hover:bg-purple-500 px-5 ml-4 py-2 text-xs shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-purple-300 hover:border-purple-500 text-white rounded-full transition ease-in duration-300">تنظیم آدرس</a>
                                        <a href="{{route('schedules.index')}}"  class="flex-no-shrink bg-purple-400 hover:bg-purple-500 px-5 ml-4 py-2 text-xs shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-purple-300 hover:border-purple-500 text-white rounded-full transition ease-in duration-300">تنظیم ساعات کاری</a>
                                    ...
                                    <div class=" text-gray-400 my-1  mx-auto flex flex-col  text-right">
                                        <span class="text-xl ">آدرس : {{Auth::user()->restaurant->address->address ?? ''}}</span>
