            ...
            <div class="container  m-4">
                <div class="max-w-3xl w-full mx-auto grid gap-4 grid-cols-1">
                    ...
                    <div class="flex justify-between">
                        ...
                        <a href="{{route('addresses.edit', Auth::user()->restaurant->address)}}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">تغییر آدرس</a>
            ...
            @else
                <div class="h-[calc(100vh)] w-full bg-gray-900">
                    <div class="w-96 mx-auto pt-8 space-y-12">
                        ...
                        <h1 class="text-xl text-center mx-auto text-green-600">شما هنوز آدرسی ندارید</h1>
                        <div class="flex justify-between">
                            ...
                            <a href="{{route('addresses.create')}}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">افزودن آدرس</a>
